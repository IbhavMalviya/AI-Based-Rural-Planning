      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <CardDescription>{t("section.insights_desc")}</CardDescription>
          </div>
          <InfoTooltip content="Insights generated by analyzing 5 years of weather data, soil composition, and agricultural best practices for Indian conditions." />
        </div>
      </CardHeader>
          ...
          <div key={index} className="flex gap-4 p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
            ...
            <div className="flex-1 space-y-1">
              <div className="flex items-center gap-2">
                ...
                <Badge variant={getBadgeVariant(insight.type)} className="text-xs">{insight.type}</Badge>
              </div>
